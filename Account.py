...
class Account:
    class Profile:
        def __init__(self, profiles, send: SendQueue):
            self.send = send
    ...
    def __init__(self, xclient: str, user_id: str, api_token: str, profiles, groups, sendmsgdelay: int, savelocation: str):
        self.groups = groups
    ...
    def challenge_create(self, group: int, name: str, short_name: str, summary: str = None, description: str = None, prize: int = None, official: bool = None, queued: bool = True, callback: object = None):
    ...
    def challenges_get_for_user(self, page: int, member: str, owned: str, search: str, categories: str, queued: bool = True, callback: object = None):
    ...
    def challenge_update(self, challenge_id: str, name: str = None, summary: str = None, description: str = None, queued: bool = True, callback: object = None):
        data = {}
        if name:
            data['name'] = name
        if summary:
    ...
    def challenge_member_get_process(self, challenge_id: str, user_id: str, queued: bool = True, callback: object = None):
        return self.send('get', 'api/v3/challenges/%s/members/%s' % (challenge_id, user_id), queued, callback)
    def challenge_get_members(self, challenge_id: str, last_id: str = None, limit: int = None, include_tasks: bool = None, include_all_public_fields: bool = None, queued: bool = True, callback: object = None):
    ...
    def chat_group_msg_delete(self, group_id: str, chat_id: str, queued: bool = True, callback: object = None):
        return self.send('delete', 'api/v3/groups/%s/chat/%s?previousMsg=%s' % (group_id, chat_id, self.groups[group_id]['chat'][0]['id']),
                         queued, callback)
    def chat_group_msg_flag(self, group_id: str, chat_id: str, comment: str = None, queued: bool = True, callback: object = None):
    ...
    def chat_group_msg_post(self, group_id: str, message: str, queued: bool = True, callback: object = None):
        return self.send('post', 'api/v3/groups/%s/chat?previousMsg=%s' % (group_id, self.groups[group_id]['chat'][0]['id']), queued,
    ...
    def development_set_inventory(self, gear, special, pets, mounts, eggs, hatching_potions, food, quests, queued: bool = True, callback: object = None):
    ...
    def group_invite_users(self, group_id: str, emails: list = None, uuids: list = None, queued: bool = True, callback: object = None):
        data = {}
    ...
    def group_leave(self, group_id: str, keep: str, keep_challenges: str = None, queued: bool = True, callback: object = None):
    ...
    def group_remove_member(self, group_id: str, user_id: str, message: str, queued: bool = True, callback: object = None):
    ...
    def group_get_invites(self, group_id: str, last_id: str = None, limit: int = None, include_all_public_fields: bool = None, queued: bool = True, callback: object = None):
    ...
    def group_get_members(self, group_id: str, last_id: str = None, limit: int = None, include_tasks: bool = None, include_all_public_fields: bool = None, queued: bool = True, callback: object = None):
    ...
    def inbox_get_messages(self, page: int, conversation_id: str, queued: bool = True, callback: object = None):
        return self.send('get', 'api/v3/inbox/messages?page=%d&conversation=%s' % (page, conversation_id), queued, callback)

    def user_get_groups(self, grouptypes: [str], paginate: str = None, page: int = None, queued: bool = True, callback: object = None):
    ...
    def user_get_objections_to_interaction(self, user_id: str, interaction: str, queued: bool = True, callback: object = None):
    ...
    def task_create_for_user(self, text: str, tasktype: str, tags: [str] = None, checklist: list = None, alias: str = None, attribute: str = None,
                             collapse_check_list: bool = False, notes: str = None, date: str = None,
                             priority: float = 1, reminders: [dict] = None, frequency: str = 'weekly',
                             repeat: {str: False} = True, every_x: int = None, streak: int = 0,
                             days_of_month: [int] = None, weeks_of_month: [int] = None, start_date: str = None,
    ...
    def challenge_get_tasks(self, challenge_id: str, tasktype: str = None, queued: bool = True, callback: object = None):
